...
public static class UpdateOrganizations
{
    ...
    {
        var organizationForUpdate = Entities.Organization.CreateOrganization(
            id: request.Id,
            name: request.Name,
            cnpj: request.Cnpj,
        ...
        var validationResult = await validator.ValidateAsync(organizationForUpdate);

        if (!validationResult.IsValid)
            return Results.BadRequest(validationResult.Errors);

        var organization = await context.Organizations.FindAsync(organizationForUpdate.Id);
        ...
        context.Entry(organization).CurrentValues.SetValues(organizationForUpdate);
